  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form action="">
        ...
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700"
        >
          Create Listing
        </button>
      </form>
