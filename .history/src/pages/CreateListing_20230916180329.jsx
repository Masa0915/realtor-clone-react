          ...
          <div className="">
            <div>
              ...
              <input
                ...
                onChange={onChange}
                required
                className="w-full px-4 y-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700"
              />
            </div>
          </div>
        )}
