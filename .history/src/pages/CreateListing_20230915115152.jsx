        ...
        <div className="">
          <div className="">
            ...
            <input
              ...
              max="50"
              required
              className="px-4 py-2 text-xl text-gray-700 bg-white border border-gray rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600"
            />
          </div>
        </div>
      </form>
